...
const ContactUs = () => {
 ...
 const onSubmit = async (event) => {
  ...
  return (
    <div
        id='contact-us' className='flex flex-col items-center gap-7 px-4 sm:px-12 lg:px-24 xl:px-40 pt-30 text-gray-700 dark:text-white  bg-gray-100 dark:bg-gray-950'>
        <Title title='Reach out to us' desc='From our kitchen to your table, we prepare nutritious meals made with care — for a healthier you.' />
